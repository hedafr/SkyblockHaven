package de.skyh.skyhaven.partyfinder;
...
public class RuleEditorGui extends GuiScreen {
    ...
    public RuleEditorGui() {
        this.rules = Skyhaven.getInstance().getPartyFinderRules();
        expertMode = !SkyhConfig.dungPartyFinderRuleEditorSimplified;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (btnBackToConfig.isMouseOver()) {
            drawHoveringText(Arrays.asList("Go to Party Finder config options", EnumChatFormatting.YELLOW + " ‣ /skyh config party finder"), mouseX, mouseY);
            ...
            helpTooltip.add(EnumChatFormatting.GREEN + "If you have any questions or need help with the rules editor: Join the SkyhX discord!");
            helpTooltip.add("");
            ...
            helpTooltip.add("");
            helpTooltip.add(EnumChatFormatting.GRAY + "If you want to use Regular Expressions (regex), you can enable them via " + EnumChatFormatting.YELLOW + "/skyh config regex");
    ...
    protected void actionPerformed(GuiButton button) {
        if (button == btnBackToConfig) {
            rules.saveToFile();
            mc.displayGuiScreen(new SkyhConfigGui("party finder"));
            ...
            GuiConfirmOpenLink guiHelp = new GuiConfirmOpenLink(this, Skyhaven.INVITE_URL, 50000000, true);
