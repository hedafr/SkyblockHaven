            ...
            public String getDungeonTypesLevels() {
                ...
                if (dungeon_types != null && !dungeon_types.isEmpty()) {
                    for (Map.Entry<String, HySkyBlockStats.Profile.Dungeons.Type> dungeonType : dungeon_types.entrySet()) {
                        ...
                        dungeonTypesLevels.append(Utils.fancyCase(dungeonType.getKey().substring(0, 4))).append(" ").append(SkyhConfig.useRomanNumerals() ? Utils.convertArabicToRoman(dungeonTypeLevel) : dungeonTypeLevel);
                    }
            ...
            public static class Type {
                ...
                public String getSummary(boolean isMasterFloor) {
                    ...
                    if (tier_completions != null && tier_completions.size() > 0) {
                        ...
                        floorCompletion = "" + highestTierCompletions + EnumChatFormatting.GRAY + "x " + EnumChatFormatting.YELLOW + "Floor " + (SkyhConfig.useRomanNumerals() ? Utils.convertArabicToRoman(highest_tier_completed) : highest_tier_completed);
                    } else {
