...
import de.skyh.skyhaven.search.GuiTooltip;
...
public class ChestOverviewGui extends GuiScreen {
    ...
    public ChestOverviewGui(Skyhaven main) {
        this.screenTitle = Skyhaven.MODNAME + " Chest Analyzer";
        this.main = main;
    ...
    public void initGui() {
        ...
        addTooltip(btnHelp, Arrays.asList("" + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + screenTitle,
                EnumChatFormatting.GRAY + "You can set the default settings via " + EnumChatFormatting.YELLOW + "/skyh config chest",
                "",
        ...
        this.buttonList.add(this.btnBazaarInstantOrOffer = new GuiButton(15, this.width - 78, this.height - 51, 75, 12, SkyhConfig.useInstantSellBazaarPrices() ? "via Insta-Sell" : "via Sell Offer"));
        ...
        this.buttonList.add(this.chkShowBazaarItems = new GuiCheckBox(10, this.width - 162, this.height - 50, " Bazaar items", SkyhConfig.chestAnalyzerShowBazaarItems));
        ...
        this.buttonList.add(this.chkShowLowestBinItems = new GuiCheckBox(11, this.width - 162, this.height - 39, " lowest BIN items", SkyhConfig.chestAnalyzerShowLowestBinItems));
        ...
        this.buttonList.add(this.chkShowNpcItems = new GuiCheckBox(12, this.width - 162, this.height - 28, " NPC items", SkyhConfig.chestAnalyzerShowNpcItems));
        ...
        this.buttonList.add(this.chkShowNoPriceItems = new GuiCheckBox(13, this.width - 162, this.height - 15, " items without price", SkyhConfig.chestAnalyzerShowNoPriceItems));
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            if (button == btnClose) {
                ...
                mc.displayGuiScreen(new GuiChat("/skyh config chest"));
    ...
    public void onGuiClosed() {
        if (SkyhConfig.chestAnalyzerShowCommandUsage) {
            main.getChatHelper().sendMessage(new SkyhChatComponent(EnumChatFormatting.GRAY + "Use " + EnumChatFormatting.WHITE + "/skyh analyzeChests stop " + EnumChatFormatting.GRAY + "to stop the Chest Analyzer.").setSuggestCommand("/skyh analyzeChests stop")
                    .appendFreshSibling(new SkyhChatComponent(EnumChatFormatting.GRAY + "Or continue adding more chests and run " + EnumChatFormatting.WHITE + "/skyh analyzeChests " + EnumChatFormatting.GRAY + " again to re-run the analysis.").setSuggestCommand("/skyh analyzeChests")));
        }
    }
