package de.onyxp.onyxpannel.search;
...
public class GuiSearch extends GuiScreen {
    ...
    private final ExecutorService executorService = new ThreadPoolExecutor(0, 1,
            ...
            new LinkedBlockingQueue<>(), new ThreadFactoryBuilder().setNameFormat(Onyxpannel.MODID + "-logfilesearcher-%d").build());
    // data
    ...
    public GuiSearch(String initialSearchQuery) {
        this.mcLogOutputFile = new File(Onyxpannel.getInstance().getModOutDirectory(), "onyxpannel-mc-log-search-temp.txt");
        try {
        ...
        this.dateStart = OnyxConfig.calculateStartDate();
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        if (button == this.buttonSearch) {
            ...
            this.searchResults.add(new LogEntry("" + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "Performing a search " + EnumChatFormatting.GRAY + EnumChatFormatting.ITALIC + "/onyx search [initial search term]"));
            ...
            for (Property configEntry : Onyxpannel.getInstance().getConfig().getLogSearchProperties()) {
                logSearchConfigElements.add(new ConfigElement(configEntry));
            }
            mc.displayGuiScreen(new GuiConfig(this,
                    logSearchConfigElements,
                    Onyxpannel.MODID, "onyxpannelLogSearchConfig", false, false,
