package de.onyxp.onyxpannel;

import de.onyxp.onyxpannel.chesttracker.ChestTracker;
import de.onyxp.onyxpannel.command.*;
import de.onyxp.onyxpannel.config.CredentialStorage;
import de.onyxp.onyxpannel.config.OnyxConfig;
import de.onyxp.onyxpannel.handler.AnalyzeIslandTracker;
import de.onyxp.onyxpannel.handler.DungeonCache;
import de.onyxp.onyxpannel.handler.FriendsHandler;
import de.onyxp.onyxpannel.handler.PlayerCache;
import de.onyxp.onyxpannel.listener.ChatListener;
import de.onyxp.onyxpannel.listener.PlayerListener;
import de.onyxp.onyxpannel.partyfinder.Rules;
import de.onyxp.onyxpannel.util.ChatHelper;
import de.onyxp.onyxpannel.util.VersionChecker;
...
@Mod(modid = Onyxpannel.MODID, name = Onyxpannel.MODNAME, version = Onyxpannel.VERSION,
        clientSideOnly = true,
        updateJSON = "https://raw.githubusercontent.com/onyx-mc/Onyxpannel/master/update.json")
public class Onyxpannel {
    ...
    private static Onyxpannel instance;
    private File modsDir;
    private File configDir;
    private File modOutDir;
    private OnyxConfig config;
    private CredentialStorage onyx;
    ...
    public void preInit(FMLPreInitializationEvent e) {
        ...
        onyx = new CredentialStorage(new Configuration(new File(configDir, "do-not-share-me-with-other-players.cfg")));
        ...
        config = new OnyxConfig(this, new Configuration(new File(configDir, MODID + ".cfg"), "2"));
    }
    ...
    public void init(FMLInitializationEvent e) {
        ...
        ClientCommandHandler.instance.registerCommand(new OnyxCommand(this));
        ...
        for (String tabCompletableNamesCommand : OnyxConfig.tabCompletableNamesCommands) {
            ClientCommandHandler.instance.registerCommand(new TabCompletableCommand(this, tabCompletableNamesCommand));
        }
        // key bindings
        keyBindings = new KeyBinding[2];
        keyBindings[0] = new KeyBinding("key.onyxpannel.onyx", Keyboard.KEY_NONE, "key.onyxpannel.category");
        keyBindings[1] = new KeyBinding("key.onyxpannel.waila", Keyboard.KEY_NONE, "key.onyxpannel.category");
    ...
    public void postInit(FMLPostInitializationEvent e) {
        ...
        modOutDir = new File(Minecraft.getMinecraft().mcDataDir, Onyxpannel.MODID.toLowerCase() + "_out");
    }

    public OnyxConfig getConfig() {
        return config;
    }

    public CredentialStorage getOnyx() {
        return onyx;
    }
     ...
     */
    public static Onyxpannel getInstance() {
        return instance;
    }
}
