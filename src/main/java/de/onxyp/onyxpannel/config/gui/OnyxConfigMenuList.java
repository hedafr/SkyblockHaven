 ...
 */
public class OnyxConfigMenuList extends GuiScrollingList {
    private final OnyxConfigGui parent;

    public OnyxConfigMenuList(OnyxConfigGui parent, int listWidth) {
    ...
    protected int getSize() {
        return OnyxConfig.getConfigCategories().size();
    }
    ...
    protected void drawSlot(int idx, int right, int top, int height, Tessellator tess) {
        OnyxConfigCategory configCategory = OnyxConfig.getConfigCategories().get(idx);
