...
public class OnyxConfigPreview {
    ...
    public static OnyxConfigGui parent;

    public OnyxConfigPreview(IChatComponent chatComponent) {
        this.type = Type.CHAT;
        this.chatComponent = chatComponent;
    }

    public OnyxConfigPreview(ItemStack... items) {
        this.type = Type.ITEM;
        this.items = items;
    }

    public OnyxConfigPreview(PreviewChatRunnable previewRunnable) {
        this.type = Type.RUNNABLE;
        this.previewRunnable = previewRunnable;
    }

    public OnyxConfigPreview(String sound, float volume, float pitch) {
    ...
    public OnyxConfigPreview(DataHelper.DungeonClass dungeonClass) {
        this(new OnyxConfigPreview.PreviewChatRunnable() {
            @Override
            public IChatComponent getText() {
                String markWith;
                switch (OnyxConfig.dungeonPartyMarker(dungeonClass)) {
                    case UNIDEAL_DUPE:
                ...
                return new OnyxChatComponent("Marked with: " + markWith).gray();
            }
        });
    }
    ...
    public static IChatComponent createDemoOnline(String name, String gameMode, String onlineTime) {
        return new OnyxChatComponent(name).darkGreen().setHover(new OnyxChatComponent(gameMode).yellow().appendFreshSibling(new OnyxChatComponent("Online for " + onlineTime).white()));
    }
