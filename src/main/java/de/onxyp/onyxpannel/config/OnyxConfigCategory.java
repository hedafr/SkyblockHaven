 ...
 */
public class OnyxConfigCategory {
    private final String displayName;
    private final String configName;
    private String menuDisplayName;
    private final List<SubCategory> subCategories;

    public OnyxConfigCategory(String displayName, String configName) {
    ...
    public static class SubCategory {
         ...
         */
        private final Map<Integer, OnyxConfigPreview> previews = new HashMap<>();

        public SubCategory(String subCatName) {
            this.displayName = subCatName;
        }

        public Property addConfigEntry(Property configEntry, OnyxConfigPreview configEntryPreview) {
        ...
        public Property addConfigEntry(Property configEntry) {
            configEntry.setLanguageKey(Onyxpannel.MODID + ".config." + configEntry.getName());
            configEntries.add(configEntry);
            return configEntry;
        }

        public void addPropertyPreview(Property property, OnyxConfigPreview preview) {
        ...
        public OnyxConfigPreview getPreview(Property property) {
            int propId = configEntries.indexOf(property);
            if (propId > -1) {
        ...
        public Map<Integer, OnyxConfigPreview> getPreviews() {
            return previews;
        }
