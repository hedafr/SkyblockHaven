...
import de.onyxp.onyxpannel.search.GuiTooltip;
...
public class ChestOverviewGui extends GuiScreen {
    ...
    public ChestOverviewGui(Onyxpannel main) {
        this.screenTitle = Onyxpannel.MODNAME + " Chest Analyzer";
        this.main = main;
    ...
    public void initGui() {
        ...
        addTooltip(btnHelp, Arrays.asList("" + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + screenTitle,
                EnumChatFormatting.GRAY + "You can set the default settings via " + EnumChatFormatting.YELLOW + "/onyx config chest",
                "",
        ...
        this.buttonList.add(this.btnBazaarInstantOrOffer = new GuiButton(15, this.width - 78, this.height - 51, 75, 12, OnyxConfig.useInstantSellBazaarPrices() ? "via Insta-Sell" : "via Sell Offer"));
        ...
        this.buttonList.add(this.chkShowBazaarItems = new GuiCheckBox(10, this.width - 162, this.height - 50, " Bazaar items", OnyxConfig.chestAnalyzerShowBazaarItems));
        ...
        this.buttonList.add(this.chkShowLowestBinItems = new GuiCheckBox(11, this.width - 162, this.height - 39, " lowest BIN items", OnyxConfig.chestAnalyzerShowLowestBinItems));
        ...
        this.buttonList.add(this.chkShowNpcItems = new GuiCheckBox(12, this.width - 162, this.height - 28, " NPC items", OnyxConfig.chestAnalyzerShowNpcItems));
        ...
        this.buttonList.add(this.chkShowNoPriceItems = new GuiCheckBox(13, this.width - 162, this.height - 15, " items without price", OnyxConfig.chestAnalyzerShowNoPriceItems));
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            if (button == btnClose) {
                ...
                mc.displayGuiScreen(new GuiChat("/onyx config chest"));
    ...
    public void onGuiClosed() {
        if (OnyxConfig.chestAnalyzerShowCommandUsage) {
            main.getChatHelper().sendMessage(new OnyxChatComponent(EnumChatFormatting.GRAY + "Use " + EnumChatFormatting.WHITE + "/onyx analyzeChests stop " + EnumChatFormatting.GRAY + "to stop the Chest Analyzer.").setSuggestCommand("/onyx analyzeChests stop")
                    .appendFreshSibling(new OnyxChatComponent(EnumChatFormatting.GRAY + "Or continue adding more chests and run " + EnumChatFormatting.WHITE + "/onyx analyzeChests " + EnumChatFormatting.GRAY + " again to re-run the analysis.").setSuggestCommand("/onyx analyzeChests")));
        }
    }
