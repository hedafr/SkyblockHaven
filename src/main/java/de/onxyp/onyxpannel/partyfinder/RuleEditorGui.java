package de.onyxp.onyxpannel.partyfinder;
...
public class RuleEditorGui extends GuiScreen {
    ...
    public RuleEditorGui() {
        this.rules = Onyxpannel.getInstance().getPartyFinderRules();
        expertMode = !OnyxConfig.dungPartyFinderRuleEditorSimplified;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (btnBackToConfig.isMouseOver()) {
            drawHoveringText(Arrays.asList("Go to Party Finder config options", EnumChatFormatting.YELLOW + " ‣ /onyx config party finder"), mouseX, mouseY);
            ...
            helpTooltip.add(EnumChatFormatting.GREEN + "If you have any questions or need help with the rules editor: Join the OnyxX discord!");
            helpTooltip.add("");
            ...
            helpTooltip.add("");
            helpTooltip.add(EnumChatFormatting.GRAY + "If you want to use Regular Expressions (regex), you can enable them via " + EnumChatFormatting.YELLOW + "/onyx config regex");
    ...
    protected void actionPerformed(GuiButton button) {
        if (button == btnBackToConfig) {
            rules.saveToFile();
            mc.displayGuiScreen(new OnyxConfigGui("party finder"));
            ...
            GuiConfirmOpenLink guiHelp = new GuiConfirmOpenLink(this, Onyxpannel.INVITE_URL, 50000000, true);
